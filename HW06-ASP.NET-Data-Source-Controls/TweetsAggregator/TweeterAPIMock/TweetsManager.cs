...
namespace TweetsAggregator.TweeterAPIMock
{
    public class TweetsManager
    {
        // Since the new api of twiter, tweets can not be obtained unless you login. Instead of that I will return some Tweets objects from here!
        public static IEnumerable<Tweet> GetTweets(string username = "Jhon")
        {
